        ...
        <div class="left-side-inner">
            ...
            <ul class="nav nav-pills nav-stacked custom-nav">
                ...
                <?php foreach ($menus as $menu) {?>
                    <li class="menu-list <?= $menu['action'] ? 'nav-active' : '';?> "><a href="<?=count($menu['children'])==0?$menu['url']:'' ?>"><i class="<?= $menu['icon']?>"></i> <span> <?= $menu['name']?> </span></a>
                        <?php if (count($menu['children']) > 0) {?>
                            <ul class="sub-menu-list">
                                <?php foreach ($menu['children'] as $child) {?>
                                    <li class="<?= $child['action'] ? 'active' : '' ?>"><a href="<?= $child['url']?>"> <?= $child['name']?></a></li>
                                <?php }?>
                            </ul>
                        <?php }?>
                    </li>
                ...
                <ul class="notification-menu">
                    ...
                    <li>
                        ...
                        <ul class="dropdown-menu dropdown-menu-usermenu pull-right">
                            ...
                            <li><a href="/site/logout"><i class="fa fa-sign-out"></i> Log Out</a></li>
                        </ul>
                    </li>
